...
export default function ProductDetails({ navigation, route }) {
    ...
    useEffect(() => {
        ...
        console.log('ProductDetails: productId:', JSON.stringify(productId), 'isNewProduct:', isNewProduct);
    ...
    const loadProductDetails = async (productId) => {
        try {
            setLoading(true);
            console.log('ProductDetails: Fetching details for product:', JSON.stringify(productId));
            ...
            console.log('ProductDetails: Calling API with userId:', userId, 'productId:', JSON.stringify(productId));
